...
To contribute to zsh-nvim project on [GitHub](https://github.com/luismayta/zsh-nvim), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/zsh-nvim/pulls).
...
To follow the instructions in this guide and start contributing to zsh-nvim project on GitHub:
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/zsh-nvim/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
