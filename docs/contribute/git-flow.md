<!-- Space: Projects -->
<!-- Parent: ZshNvim -->
<!-- Title: Contributing GitFlow ZshNvim -->
<!-- Label: ZshNvim -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GitFlow -->
...
To contribute to zsh-nvim project on [GitHub](https://github.com/luismayta/zsh-nvim), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/zsh-nvim/pulls).

![workflow gitflow](https://datasift.github.io/gitflow/GitFlowHotfixBranch.png)

## Getting started

To follow the instructions in this guide and start contributing to zsh-nvim project on Gitlab:
